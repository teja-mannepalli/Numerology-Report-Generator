...
# save_path = ""
if save_path == "":
    print("Kindly enter the directory path which you would like to save the .txt files")
    print("at Line 11 in DateOfBirthCalculator.py ")
    print("Ex: D:\\DD\\DDD\\DDDD")
    print("If not you will not get the text file of the details you entered")
